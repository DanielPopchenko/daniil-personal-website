  ...
  return (
    <section id={id} className="scroll-mt-24 border-t border-line py-20 sm:py-28">
      <Reveal className="mb-12 flex items-baseline gap-5">
        <span className="font-mono text-[13px] text-accent sm:text-xs">{index}</span>
        <h2 className="font-mono text-[13px] uppercase tracking-[0.18em] text-muted sm:text-xs sm:tracking-[0.22em]">
          {title}
        </h2>
